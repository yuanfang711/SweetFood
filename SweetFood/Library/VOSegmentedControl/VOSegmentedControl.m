...
- (void)commonInit{
    ...
    self.selectedTextColor       = [UIColor colorWithRed:96.0/255.0 green:185.0/255.0 blue:191.0/255.0 alpha:1.0];
    ...
    self.selectedIndicatorColor  = [UIColor colorWithRed:96.0/255.0 green:185.0/255.0 blue:191.0/255.0 alpha:1.0];
